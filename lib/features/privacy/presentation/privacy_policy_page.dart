                    ...
                    child: ListView(
                      ...
                      children: const [
                        ...
                        _PolicySection(
                          ...
                          body: 'Sudoku application code does not collect personal or sensitive user data by transmitting it away from your device. It does not disclose or sell personal data, game data, or device data to advertisers, data brokers, analytics providers, or other companies. No third-party SDK is configured to collect data from the app.\n\nThe learning path contains optional links to tutorials on YouTube. Sudoku does not embed the YouTube player, load remote thumbnails, set YouTube cookies, or contact YouTube merely because you open a lesson. A connection is made only after you explicitly select an external tutorial. Your browser or the YouTube app then opens YouTube, which may process information under Google\'s Privacy Policy and YouTube terms. Sudoku does not send your puzzle, learning progress, or other save data with the link.\n\nGitHub receives the limited web-request information described above when it hosts the web version. Google Play, YouTube, an operating system, a browser, a network provider, or a distribution platform may independently process information when you download, install, update, follow an external link, back up, or access software. That independent processing is not controlled by Sudoku and does not give Sudoku access to your account or payment information.',
                        ),
                        _PolicySection(
